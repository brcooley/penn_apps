...
class FlashFoto:
    ...
    '''
    def __make_request(self, url, method='GET', post_data=None, decode=True):
        ...
        conn.request(method, url, post_data)
        # get the response
    ...
    '''
    def copy(self, image_id, params=None):
    ...
    Removes an image
    '''
    def delete(self, image_id, params=None):
    ...
    '''
    def info(self, image_id, params=None):
    ...
    '''
    def findfaces_status(self, image_id):
    ...
    '''
    def segment_status(self, image_id):
    ...
    '''
    def compose(self, image_id, params):
